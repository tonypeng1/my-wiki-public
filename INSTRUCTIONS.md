...
Each wiki/concepts/{name}.md should follow this structure:
...
## Summary File Format
Each wiki/summaries/{name}.md should follow this structure:
...
## Query File Format
Each wiki/queries/{slugified-question}.md should follow this structure:
...
## Answer
Full, thorough answer to the question.
...
## Index Format
Each entry in wiki/index.md should follow this structure:
